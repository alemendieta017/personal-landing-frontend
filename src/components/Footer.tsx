      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-3">
            <h4 className="text-sm font-bold uppercase tracking-wider text-white">
              Tu {agentData.genero === "masculino" ? "Ejecutivo" : "Ejecutiva"}{" "}
              De Ventas
            </h4>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
              La fibra óptica de Personal está calificada como la más rápida de
              Paraguay. Comprobado por usuarios independientes y certificado
              internacionalmente por <strong>Ookla® Speedtest®</strong>.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p className="text-center md:text-left">
            &copy; {new Date().getFullYear()} Personal Paraguay. Todos los
            derechos reservados.
          </p>
          <p className="text-center md:text-right">
            Esta es una landing page de prospección comercial. Sujeto a
            disponibilidad técnica de cobertura en el edificio.
          </p>
        </div>
      </div>
    </footer>
