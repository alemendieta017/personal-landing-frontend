    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 antialiased selection:bg-personal-blue selection:text-white">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-sm sm:text-base text-slate-600 font-medium leading-relaxed">
              {comboBlock?.subtitle ||
                "Combinando tus productos de Internet Fibra, Flow TV y Telefonía móvil, accedés a beneficios exclusivos y duplicás tus velocidades de forma automática."}
            </p>
          </div>
                      ...
                      <div className="flex flex-col gap-3.5 my-6">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col text-left">
                            <span
                              className={`text-[10px] font-bold uppercase tracking-wider ${combo.isPopular ? "text-slate-400" : "text-slate-500"}`}
                            >
                        ...
                        {hasTv && (
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col text-left">
                              ...
                              <span
                                className={`text-sm font-extrabold ${combo.isPopular ? "text-white" : "text-slate-900"}`}
                              >
                                Flow TV
                              </span>
                            </div>
      ...
      >
        ...
        <div className="absolute inset-0 opacity-20 pointer-events-none select-none">
          ...
          >
            <path
              d="M 0 100 Q 360 80 720 150 T 1440 100"
              fill="none"
              stroke="rgba(255, 255, 255, 0.25)"
              strokeWidth="3"
            />
            <path
              d="M 0 250 Q 400 350 800 200 T 1440 300"
              fill="none"
              stroke="rgba(255, 255, 255, 0.2)"
              strokeWidth="2"
            />
            <path
              d="M 0 450 Q 300 400 750 480 T 1440 420"
              fill="none"
                    ...
                    <div className="flex items-center gap-2 sm:gap-5 flex-shrink-0">
                      <div className="relative flex flex-col items-end justify-center">
                        <p className="text-xl sm:text-3xl font-extrabold text-white leading-none">
                          <span className="font-light text-slate-300 mr-1 text-sm sm:text-2xl">
                            Gs.
                          </span>
      ...
      >
        ...
        <div className="absolute inset-0 opacity-20 pointer-events-none select-none">
          ...
          >
            <path
              d="M 0 150 Q 400 50 800 250 T 1440 150"
              fill="none"
              stroke="rgba(255, 255, 255, 0.25)"
              strokeWidth="2.5"
            />
            <path
              d="M 0 350 Q 300 450 750 300 T 1440 380"
              fill="none"
              stroke="rgba(255, 255, 255, 0.15)"
              strokeWidth="1.5"
            ...
            <path
              d="M 120 180 L 135 190 L 120 200 Z"
              fill="none"
              stroke="rgba(255, 255, 255, 0.2)"
              strokeWidth="1.5"
            />
            <path
              d="M 1320 250 L 1335 260 L 1320 270 Z"
              fill="none"
              stroke="rgba(255, 255, 255, 0.2)"
              strokeWidth="1.5"
            />
                  ...
                  <ul className="mt-8 space-y-3">
                    ...
                    {item.type !== "con_decodificador" && (
                      <li className="flex items-start gap-2.5 text-[10px] text-slate-400 bg-black/30 p-3 rounded-xl border border-white/5 mt-4">
                        ...
                        <span>
                          La App de Flow requiere dispositivos con Android 8.0 o
                          superior para su funcionamiento.
                        </span>
                      </li>
                    )}
                  </ul>
          ...
          <div className="mt-12 bg-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl max-w-4xl mx-auto text-slate-800">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-4">
              <div className="text-center flex flex-col items-center">
                ...
                <p className="text-[11px] text-slate-500 mt-2 leading-relaxed max-w-[180px] mx-auto">
                  Llamadas y mensajes sin límites a todas las compañías del
                  país.
                </p>
              </div>
              ...
              <div className="text-center flex flex-col items-center">
                ...
                <p className="text-[11px] text-slate-500 mt-2 leading-relaxed max-w-[180px] mx-auto">
                  Navegá a la máxima velocidad 4G/5G en la red más rápida del
                  país.
                </p>
              </div>
              ...
              <div className="text-center flex flex-col items-center">
                ...
                <p className="text-[11px] text-slate-500 mt-2 leading-relaxed max-w-[180px] mx-auto">
                  5GB adicionales exclusivos para disfrutar contenido en Flow
                  App.
                </p>
              </div>
                ...
                <div className="text-left flex flex-col h-full justify-between">
                  ...
                  <div className="my-4 bg-sky-50/75 rounded-2xl py-2.5 px-4 flex items-center justify-between border border-sky-100/50">
                    ...
                    <div className="flex items-baseline gap-0.5">
                      ...
                      <span className="text-xl sm:text-2xl font-black text-personal-blue tracking-tight leading-none">
                        {formatGs(plan.precio)}
                      </span>
                    </div>
                  </div>
